"""Run ITC 2019 NSGA-III with OpenAI Inspector and Planner roles."""
...
from controller import MultiAgentController  # noqa: E402
...
def main() -> None:
    ...
    baseline_cli.main(
        controller_factory=MultiAgentController,
        pipeline_root=ROOT,
        pipeline_name="NSGA-III + Inspector-Planner",
