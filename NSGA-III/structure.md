...
> Tài liệu này mô tả thiết kế HCMUT 261 trước đây. Baseline ITC 2019 hiện dùng
> `main.py` và các module trong `itc2019/`; xem `README.md` để chạy theo instance
> hoặc theo manifest subset.
